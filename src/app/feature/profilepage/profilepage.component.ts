...
import { Schema } from 'src/app/interface/schema';
...
export class ProfilepageComponent implements OnInit {
  ...
  url='http://localhost:4200/assets/images/profile.png'
    ...
    getuserprofile(){
      this.service.getProfile().subscribe((data:Schema)=>{
    ...
    onSubmit(){
      this.service.editProfilePhoto(this.userProfile[this.userProfile.length-1].id,this.profileForm.value).subscribe((response:Schema)=>
